...
// =====================================================================
// HANDLERS LEGADOS PARA COMPATIBILIDADE (A SEREM REMOVIDOS)
// =====================================================================

/**
 * Handlers específicos para acordos comerciais (compatibilidade)
 * ESTES LISTENERS FORAM REMOVIDOS PARA UNIFICAR OS EVENTOS COM 'agreementProposalReceived'
 * A LÓGICA AGORA É TRATADA PELO HANDLER UNIFICADO ACIMA.
 */
