...
import '../../assets/styles/GameMap.css';
import MaritimeChokepoints from './MaritimeChokepoints';
...
const GameMap = () => {
  ...
  const addMaritimeChokepoints = () => {
    if (!map.current || !map.current.loaded()) {
      console.log('Mapa não está pronto para adicionar chokepoints');
      return;
    }
    
    console.log('Adicionando chokepoints diretamente no GameMap');
  ...
  return (
    <div className="map-container">
      ...
      <MaritimeChokepoints map={map.current} />
    </div>
  );
};
